...
export default class Nav extends Component {
  ...
  <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
    <a className="navbar-brand ml-5" href="1">Order online or call us:(+91)232456525</a>
    ...
    <form className="form-inline my-2 my-lg-0 mr-5">
      <input className="form-control mr-sm-2" type="search" placeholder="Search for aproduct" aria-label="Search"/>
