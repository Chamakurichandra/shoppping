...
export default class Header extends Component {
  ...
  <button className="navbar-toggler bg-warning" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo02" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
  ...
  <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <div className="inline my-2 my-lg-0 mr-5 pr-5 carts text-white">
